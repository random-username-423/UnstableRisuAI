...
<span
    class="avatar flex shrink-0 items-center justify-center"
...
>
    {#if src}
        {#if src === "slot"}
            <div
                class="bg-skin-border sidebar-avatar flex items-center justify-center rounded-md bg-opacity-50 bg-top"
