<script lang="ts">
    ...
    import { setDatabase, type folder } from "../../ts/data/storage/database.svelte"
    ...
    import { addCharacter, changeChar, getCharImage } from "../../ts/character/characters"
