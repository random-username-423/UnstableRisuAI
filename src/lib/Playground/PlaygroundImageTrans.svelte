<script lang="ts">
    ...
    import { jsonOutputTrimmer, selectSingleFile } from "src/ts/utils/util"
    ...
    async function render() {
        ...
        for (const item of data) {
            ...
            const textSizes = [
                288, 216, 192, 144, 120, 108, 96, 84, 76, 72, 68, 64, 60, 56, 52, 48, 44, 40, 36, 32, 28, 24, 20, 18,
                16, 14, 12, 10,
            ]
            let lineHeight = 0
...
<span class="mt-4 text-lg text-textcolor">{language.font}</span>
<TextInput bind:value={fontFamily} />

<span class="mt-4 text-lg text-textcolor">fontSize</span>
...
{#if output}
    <span class="mt-4 text-lg text-textcolor">JSON</span>
...
<div class="relative mt-2">
    ...
    <div
        bind:this={selection}
        class="pointer-events-none absolute left-0 top-0 z-10 h-0 w-0 bg-blue-500 opacity-50"
