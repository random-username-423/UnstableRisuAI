...
{#if MobileState.sideBarMenu > 0}
    <div
        class="flex w-full items-center justify-start gap-2 border-b border-b-darkborderc bg-darkbg px-2 py-1 text-textcolor2"
    >
        <button
            class="flex-1 border-r border-r-darkborderc"
            class:text-textcolor={MobileState.sideBarMenu === 1}
            onclick={() => {
        ...
        <button
            class="flex-1 border-r border-r-darkborderc"
            class:text-textcolor={MobileState.sideBarMenu === 2}
            onclick={() => {
        ...
        <button
            class:text-textcolor={MobileState.sideBarMenu === 3}
            onclick={() => {
...
{/if}
<div class="relative w-full flex-1 overflow-y-auto bg-bgcolor">
    {#if MobileState.sideBarMenu > 0}
        <div class="mt-2 flex h-full w-full flex-col p-2">
