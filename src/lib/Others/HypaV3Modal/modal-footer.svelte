...
<div class="mt-2 sm:mt-4">
    {#await getNextSummarizationTarget() then nextMessage}
        {#if nextMessage}
            ...
            <textarea
                class="min-h-40 w-full resize-none overflow-y-auto rounded border border-zinc-700 bg-zinc-900 p-2 text-zinc-200 transition-colors focus:outline-none sm:min-h-56 sm:p-4"
                readonly
