...
<div
    class="relative flex h-full w-full border p-4"
...
></div>
{#if menuOpen}
    <div class="z-20 flex h-full w-138 max-w-full flex-col gap-2 border-l border-l-black bg-white p-4 text-black">
        <div class="flex">
            <button
                class="mr-2 rounded border border-black p-2"
...
{:else}
    <button
        class="absolute right-0 top-0 z-20 rounded border bg-white p-2"
        onclick={() => {
            menuOpen = !menuOpen
        }}>Menu</button
    >
