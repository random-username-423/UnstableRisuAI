...
<div class="mb-6">
    ...
    <button
        ...
        class="ml-2 mr-2 mt-2 flex w-full items-center justify-center border-1 border-solid border-darkborderc p-3 text-sm drop-shadow-lg hover:bg-selected"
    >
        {language.savebackup}
    </button>
...
<div class="mt-6 border-t border-darkborderc pt-4">
    ...
    <div class="mt-3">
        <CheckInput
            bind:check={DBState.db.syncEnabled}
            onChange={toggleSync}
            name={language.syncEnabled || "Enable Real-time Sync"}
        />
    </div>
