...
{#if hideText}
    ...
    <input
        class={"peer rounded-md border border-darkborderc bg-transparent text-textcolor shadow-sm transition-colors duration-200 focus:border-borderc focus:outline-none focus:ring-2 focus:ring-borderc" +
            (className ? " " + className : "")}
