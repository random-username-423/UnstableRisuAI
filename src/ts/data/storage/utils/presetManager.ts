...
export function saveCurrentPreset(){
    ...
    const savedPreset: botPreset = {
        ...
        promptTemplate: db.promptTemplate ?? undefined,
        ...
        reverseProxyOobaArgs: safeStructuredClone(db.reverseProxyOobaArgs) ?? undefined,
        top_p: db.top_p ?? 1,
        promptSettings: safeStructuredClone(db.promptSettings) ?? undefined,
...
export function setPreset(db:Database, newPres: botPreset): Database{
    ...
    db.NAIadventure = newPres.NAIadventure ?? false
    db.NAIappendName = newPres.NAIappendName ?? false
