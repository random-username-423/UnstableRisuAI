        ...
        if (self.showProfile) {
            ...
            if (self.showTags) {
                ...
                for (let i = 0; i < self.tagLayout.length; i++) {
                    ...
                    if (widget) {
                        ...
                        if (style_dict.style == "transparent_bg") {
                            css_styles.push("background:transparent", `border:1px solid ${style_dict.color}`)
                            ...
                            css_styles.push(`background:${style_dict.color}`, "border:none")
                        }
                ...
                if (tags_html.length > 0) {
                    const container_styles = ["text-align:center", "margin:0 auto", "max-width:fit-content"]
