...
const GeminiAPIModels: LLMModel[] = [
    // ===== Gemini 3.0 Series (2025-11) =====
    {
        ...
        flags: [LLMFlags.hasFirstSystemPrompt, LLMFlags.geminiThinking, LLMFlags.geminiBlockOff, LLMFlags.hasImageInput, LLMFlags.hasImageOutput, LLMFlags.poolSupported, LLMFlags.hasAudioInput, LLMFlags.hasVideoInput, LLMFlags.hasStreaming, LLMFlags.requiresAlternateRole],
    ...
    // ===== Gemini 2.5 Series (2025-03~09) =====
    {
        ...
        provider: LLMProvider.GeminiAPI,
        format: LLMFormat.GeminiAPI,
        flags: [LLMFlags.hasFirstSystemPrompt, LLMFlags.hasImageInput, LLMFlags.poolSupported, LLMFlags.hasAudioInput, LLMFlags.hasVideoInput, LLMFlags.hasStreaming, LLMFlags.requiresAlternateRole, LLMFlags.geminiThinking],
    ...
    },
    {
        ...
        provider: LLMProvider.GeminiAPI,
        format: LLMFormat.GeminiAPI,
        flags: [LLMFlags.hasFirstSystemPrompt, LLMFlags.geminiBlockOff, LLMFlags.hasImageInput, LLMFlags.poolSupported, LLMFlags.hasAudioInput, LLMFlags.hasVideoInput, LLMFlags.hasStreaming, LLMFlags.requiresAlternateRole, LLMFlags.geminiThinking],
        parameters: ['thinking_tokens', 'temperature', 'top_k', 'top_p', 'presence_penalty', 'frequency_penalty'],
        tokenizer: LLMTokenizer.GeminiAPI,
    },
    // {
    ...
    // },
    {
        ...
        provider: LLMProvider.GeminiAPI,
        format: LLMFormat.GeminiAPI,
        flags: [LLMFlags.hasFirstSystemPrompt, LLMFlags.hasImageInput, LLMFlags.poolSupported, LLMFlags.hasAudioInput, LLMFlags.hasVideoInput, LLMFlags.hasStreaming, LLMFlags.requiresAlternateRole, LLMFlags.hasImageOutput],
    ...
    },
    {
        ...
        provider: LLMProvider.GeminiAPI,
        format: LLMFormat.GeminiAPI,
        flags: [LLMFlags.hasFirstSystemPrompt, LLMFlags.geminiBlockOff, LLMFlags.hasImageInput, LLMFlags.hasImageOutput, LLMFlags.poolSupported, LLMFlags.hasAudioInput, LLMFlags.hasVideoInput, LLMFlags.hasStreaming, LLMFlags.requiresAlternateRole],
        parameters: ['temperature', 'top_k', 'top_p', 'presence_penalty', 'frequency_penalty'],
        tokenizer: LLMTokenizer.GeminiAPI,
    },
    {
