...
import type { character, groupChat, loreBook } from "src/ts/data/storage/types"
...
`
    ...
    async addCharacterRegexScripts(
        id: string,
        comment: string,
        input: string,
        output: string,
