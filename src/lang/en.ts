export const languageEnglish = {
    ...
    help:{
        ...
        geminiVisionQuality: "This option is used to set the media resolution for Gemini. The higher the resolution, the more accurate the detection, but more tokens are used.",
